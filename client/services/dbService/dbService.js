...
// ==================== functions =================================================
      ...
      function sendContactUsEmail(form) {
        ...
        if(form.joinNewsLetter){
          saveNewsLetterEmail(form.email)
        }
      }
      ...
      function contactCharter(from, to, subject, message, addToNewsLetter) {
        rootRef.child("contactCharter").push({
            from: from,
            to: to,
            subject: subject,
            message: message
